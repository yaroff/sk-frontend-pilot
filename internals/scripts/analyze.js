...
// Called after webpack has finished generating stats.json file
function callback() {
  clearInterval(progress);
  process.stdout.write(
    '\n\nOpen ' + chalk.magenta('http://webpack.github.io/analyse/') + ' in your browser and upload stats.json file!' +
    chalk.blue('\n(Tip: ' + chalk.italic('CMD + double-click') + ' link!)\n\n')
  );
}
