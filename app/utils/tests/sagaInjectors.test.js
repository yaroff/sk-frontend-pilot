...
describe('injectors', () => {
  ...
  describe('ejectSaga helper', () => {
    ...
    it('should check a store if second argument is falsy', () => {
      const eject = ejectSagaFactory({});

      expect(() => eject('test')).toThrow();
    });

    it('should not check a store if second argument is true', () => {
      Reflect.deleteProperty(store, 'dispatch');
  ...
  describe('injectSaga helper', () => {
    ...
    it('it should not check a store if second argument is true', () => {
      Reflect.deleteProperty(store, 'dispatch');
    ...
    it('should save an entire descriptor in saga registry', () => {
